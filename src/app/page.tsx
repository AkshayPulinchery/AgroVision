...
export default function Dashboard() {
  ...
  const isEmpty = !loading && (!predictions || predictions.length === 0);
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Real-time farm telemetry synced to AgroVision project
            </p>
          </div>
        ...
        {isEmpty ? (
          <Card className="border-2 border-dashed bg-muted/20 p-12 text-center">
            <div className="max-w-md mx-auto space-y-4">
              <div className="bg-white p-6 rounded-full shadow-sm w-fit mx-auto mb-6">
                <Database className="h-12 w-12 text-muted-foreground" />
              </div>
              <h2 className="text-2xl font-bold">No Records Found</h2>
              <p className="text-muted-foreground">
                Your AgroVision workspace is currently empty. For a better prototyping experience, you can seed 500+ records from the Admin portal.
              </p>
